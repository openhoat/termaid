---
title: "Task Format Rules"
description: "Defines common format rules for all task files in the project including KANBAN.md and CHANGELOG.md"
tags: [format, kanban, changelog, tasks]
version: "1.0.0"
...
- `workflows/kanban.md` (to read KANBAN.md and manage tasks)
- `workflows/kanban_clean.md` (to read KANBAN.md and clean up obsolete entries)
- `rules/log_changes.md` (to write in CHANGELOG.md)
- `rules/quality_check.md` (to validate formats)
