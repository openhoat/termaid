...
description: "Defines TypeScript coding standards and best practices for the project"
...
- Enforced by ESLint/Biome rules when possible
...
- **Code Intelligence Rule**: LSP provides type information to help follow these rules
